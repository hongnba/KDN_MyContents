...
class WeeklyStatsVO(BaseMongoDocument):
    ...
    def __init__(
        ...
        daily_breakdown: Dict[str, Dict] = None,  # 일별 세부 데이터 {"1일차": {"articles_no": 5, "positive_rate": 60.0, ...}}
        weekly_contents_count_map: Dict[str, int] = None,  # {"1일차": 17, "2일차": 7, ...}
        weekly_positive_ratio_map: Dict[str, float] = None,  # {"1일차": 63.824, "2일차": 60.714, ...}
        weekly_negative_ratio_map: Dict[str, float] = None,  # {"1일차": 29.706, "2일차": 35.0, ...}
        weekly_positive_keyword_rank_map: Dict[str, List[str]] = None,  # {"1일차": ["키워드1", "키워드2"], ...}
        weekly_negative_keyword_rank_map: Dict[str, List[str]] = None,  # {"1일차": ["키워드1", "키워드2"], ...}
        weekly_most_frequent_keyword_rank_map: Dict[str, List[str]] = None,  # {"1일차": ["키워드1", "키워드2"], ...}
