...
MAIL_SEND_ID = "kepcokdnkcs@gmail.com"     #kdn

# MAIL_SEND_TOKEN = "ygqgarkrfiovqcmk"        #3way
MAIL_SEND_TOKEN = "slwcwvmbrihowpie"        #kdn
...
KAKAO_SEND_SENDER_KEY = "3245cb4ac919c6a5d4ca4394a1b8a46405abd203"
...
# 뭐하는건가? --------------------------------------------------------------------
CONTENTS_BASE_URL = "https://mycontents.kdn.com/login"
# 뭐하는건가? --------------------------------------------------------------------
