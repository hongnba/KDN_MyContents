...
# JSON 파일 경로
json_file_path = "/home/themiraclesoft/mycontents/KDN_MyContents/kSubscribe_Python_v2.0.0/src/ksubscribe_share/test/mycontents.contents_251230.json"
csv_file_path = "/home/themiraclesoft/mycontents/KDN_MyContents/kSubscribe_Python_v2.0.0/src/ksubscribe_share/test/mycontents.contents_251230.csv"
    ...
    for item in data:
        ...
        if 'contentsMeta' in item and item['contentsMeta']:
            ...
            for sentiment in sentiments:
                # keywords 배열을 문자열로 변환 (세미콜론으로 구분)
