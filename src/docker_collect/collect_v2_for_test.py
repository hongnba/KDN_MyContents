...
from docker_collect.selenium_collector_for_test import get_contents_by_selenium_main
import pytz
...
class DockerCollectMain:
    ...
    def distribute(self):
        ...
        #250827 김현지: 테스트용 기관명 입력받기
        org_input = input("테스트할 기관명을 정확히 입력해주세요: ")
        print(org_input, " 기관의 크롤링 테스트를 시작합니다.")
        ...
        for contentsOrg in contentsOrgList:     
            ...
            for category in contentsOrg.categoryList:    
                ...
                if contentsOrg.orgName == org_input: # 입력받은 기관명에 해당할 시
                    # SELENIUM 
