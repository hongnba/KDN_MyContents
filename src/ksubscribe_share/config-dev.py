...
# Ollam 모델 정보 --------------------------------------------------------------------
OLLAMA_MODEL = "gpt-oss:20b" # "llama-3-Korean-Bllossom-8B-Q4_K_M:latest"
OLLAMA_URL = "http://10.99.2.71:11434"
 

# MongoDB 트랜잭션 사용 여부 --------------------------------------------------------------------
# 개발서버(KDN, Replica Set): True
# 로컬서버(더미라클소프트, 단일 인스턴스): False
# 환경 변수로도 설정 가능: export MONGO_USE_TRANSACTION=true
MONGO_USE_TRANSACTION = True