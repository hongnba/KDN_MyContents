...
class SentimentInfo(BaseModel):
    def __init__(self, 
                 ...
                 reason:str = None, # 20251215: 통합 프롬프트(CoT)의 '종합 판단 근거' 저장
                 ...
                 neutralKeywords:List[str] = None # 20251203 추가: 중립 키워드 필드
                 ):
        self.orgId = orgId                    
...
class ContentsMeta(BaseModel):
    def __init__(
        ...
        detailSummary: str = None, # 유헌수 20260109 추가: detail summary 
        ...
        self.detailSummary = detailSummary # 유헌수 20260109 추가: detail summary 
    ...
    def to_mongo(self):
        ...
        # 유헌수 20260109 추가: detail summary 
        if hasattr(self, "detailSummary") and self.detailSummary is not None:
            mongo_data["detailSummary"] = self.detailSummary
    ...
    def from_mongo(cls: Type[T], mongo_data) : 
        ...
        if "detailSummary" in mongo_data and mongo_data.get("detailSummary") is not None:
            instance.detailSummary = mongo_data.get("detailSummary")
        else:
            instance.detailSummary = None
