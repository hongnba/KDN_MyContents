...
class data_delete_org():
    ...
    def deleteOrg(self, orgId:str):
        # contents_org
        self.contentsOrgService.remove_org_commcode(orgId)
        # contents 삭제
        self.contentsService.remove_org_commcode(orgId)
        # contents_collect_request 삭제
        self.contentsCollectRequestService.remove_org_commcode(orgId)
        # member_account 
        self.memberService.remove_org_commcode(orgId)
        # common_code 삭제
        self.commCodeService.remove_code_commcode(orgId)
        pass 
...
if __name__ == "__main__":
    ...
    mainClasss = data_delete_org()
    mainClasss.deleteOrg("A0030")
    #mainClasss.deleteOrg("A0031")    
        
    # 구독기관 삭제실행 (최미화) -> 구독기관 등록 잘되면 (조현동) -> 구독기관 삭제실행 (최미화, 조현동) 
